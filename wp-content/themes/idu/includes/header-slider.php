					...
					if(themify_check('setting-header_slider_images_'.$option.'_image')){
						echo '<li>';
							if(themify_check('setting-header_slider_images_'.$option.'_link')){ 
                                ...
                                $title = (themify_check('setting-header_slider_images_'.$option.'_title')) ? themify_get('setting-header_slider_images_'.$option.'_title') : '';
								$image = themify_get('setting-header_slider_images_'.$option.'_image');
								themify_image("src=".$image."&setting=header_slider&w=220&h=160&alt=".$image.'&class=feature-img&before=<div class="slide-feature-image"><a href="'.$image.'" rel="lightbox[slider]" title="'.$title.'">&after=</a></div>');
							}
						echo '</li>';
					}
				}
